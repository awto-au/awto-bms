...
class LastKnownState {
  ...
  /// magnitude and the charge state restore together.
  ...
  /// current (null when the pack never reported one).
  factory LastKnownState.capture(BatteryState s, {double? signedCurrent}) =>
      LastKnownState(
        ...
        packCurrent: s.packCurrent == null ? null : signedCurrent,
        power: s.power,
  ...
  void applyTo(BatteryState s) {
    ...
    if (packCurrent != null) s.packCurrent = packCurrent!.abs();
