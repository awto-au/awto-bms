...
///    / temperature faults.
///  * [alerts] — default importance: unknown-byte MAJOR changes and fleet-member
///    disconnects.
enum AlertChannel { faults, alerts }
...
class BatterySnapshot {
  ...
  /// the existing alarm logic (NOT the bogus MOS-overtemp bits).
  final bool fault;
