...
/// Desktop type scale. The Windows/Linux/macOS app renders the phone-sized
/// type otherwise; this ONE factor shrinks every text in the app by 25 % on a
/// desktop host. Mobile (and web) are untouched. Applied through the
/// [MaterialApp.builder] as a [TextScaler] composed with the platform's own.
