...
void main() {
  ...
  group('UI: two states everywhere, two controls plus Both', () {
    ...
    testWidgets('list cards show a Charge badge and an Output badge each',
      ...
      // The charging demo pack (DEMO-1) reports output OFF, charge ON.
    ...
    testWidgets(
      ...
      // The Controls card sits below Alarm events, which (#123) now carries
      // the alarm band: scroll it into view too.
      await scrollTo(tester, find.text('Charge (charge MOS)'));
