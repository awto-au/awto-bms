    ...
    return ListView(
              ...
              children: [
                ListTile(
                  ...
                  // #112: the second line makes a silent gap visible — the
                  // store can be open while a pack's frames never reach it.
                  subtitle: Text([
                    log.dbDegraded
                ...
                ListTile(
                  ...
                  subtitle: Text(
                      ...
                      ' · ${RawLogger.fmtSize(raw.totalBytes)} total in '
                      '${raw.rotatedCount + 1} files (all kept)'
